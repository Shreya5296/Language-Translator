...
input_label = Label(root,text ="Select Language", font = 'arial 13 bold', bg ='#F2CCC3')
...
output_label = Label(root,text ="Select Language", font = 'arial 13 bold', bg ='#F2CCC3')
...
footer_label = Label(root,text ="Developed by - Shreya Agarwal", font = 'arial 10 italic', bg ='#F2CCC3')
